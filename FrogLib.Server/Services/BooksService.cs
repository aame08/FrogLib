...
namespace FrogLib.Server.Services
{
    ...
    public class BooksService(FroglibContext context, IReviewsService reviewsService, ICollectionsService collectionsService) : IBooksService
    {
        ...
        public async Task<int> GetCountViewAsync(int idBook)
        {
            return await _context.Viewhistories
                .CountAsync(vh => vh.TypeEntity == TypeObject && vh.IdEntity == idBook);
        }
