...
namespace FrogLib.Server.Controllers
{
    ...
    [ApiController]
    public class AuthController(JwtProvider jwtProvider, FroglibContext context) : BaseController
    {
        private readonly JwtProvider _jwtProvider = jwtProvider;
        private readonly FroglibContext _context = context;

        [HttpPost("register")]
        public ActionResult<User> Register([FromForm] RegisterUser model)
        {
            try
            {
