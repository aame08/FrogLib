...
public partial class FroglibContext : DbContext
{
    public FroglibContext()
    {
    }

    public FroglibContext(DbContextOptions<FroglibContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            var connectionString = Environment.GetEnvironmentVariable("DefaultConnection")
                                ?? "server=localhost;user=root;password=ame0372;database=froglib";
            optionsBuilder
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Book>(entity =>
        {
            ...
            entity.Property(e => e.StatusBook)
                .HasColumnType("enum('','Новинка','Бестселлер')")
                .HasColumnName("status_book");
        ...
        modelBuilder.Entity<Comment>(entity =>
        {
            ...
            entity.Property(e => e.DateComment).HasColumnName("date_comment");
        ...
        {
            entity.HasKey(e => e.IdListType).HasName("PRIMARY");

            entity.ToTable("listtypes");

            entity.HasIndex(e => e.NameList, "name_list").IsUnique();

            entity.Property(e => e.IdListType).HasColumnName("id_list_type");
        ...
        {
            entity.HasKey(e => new { e.IdListType, e.IdUser, e.IdBook })
                .HasName("PRIMARY")
            ...
            entity.HasOne(d => d.IdBookNavigation).WithMany(p => p.Userbooks)
                .HasForeignKey(d => d.IdBook)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("userbooks_ibfk_3");

            entity.HasOne(d => d.IdListTypeNavigation).WithMany(p => p.Userbooks)
                .HasForeignKey(d => d.IdListType)
                .OnDelete(DeleteBehavior.ClientSetNull)
